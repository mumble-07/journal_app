...
class TasksControllerTest < ActionDispatch::IntegrationTest
  # test "Testing for tasks#index" do
  #   assert_routing category_tasks_path, controller: 'tasks', action: 'index'
  # end

  test 'Testing for tasks#create' do
    assert_routing({ method: 'post', path: category_tasks_path(category_id: 1) },
                   { controller: 'tasks', action: 'create', category_id: '1' })
  end
  ...
  test 'Testing for tasks#edit' do
    assert_routing({ method: 'get', path: edit_category_task_path(category_id: 1, id: 1) },
                   { controller: 'tasks', action: 'edit', category_id: '1', id: '1' })
  end

  test 'Testing for tasks#show' do
    assert_routing({ method: 'get', path: category_task_path(category_id: 1, id: 1) },
                   { controller: 'tasks', action: 'show', category_id: '1', id: '1' })
  end

  test 'Testing for tasks#update' do
    assert_routing({ method: 'put', path: category_task_path(category_id: 1, id: 1) },
                   { controller: 'tasks', action: 'update', category_id: '1', id: '1' })
  end
